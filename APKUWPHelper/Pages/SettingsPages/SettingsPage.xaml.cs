...
namespace APKUWPHelper.Pages.SettingsPages
{
    /// <summary>
    ...
    public sealed partial class SettingsPage : Page, INotifyPropertyChanged
    {
        ...
        internal string IssuePath = "https://github.com/Jomalone/APKUWPHelper/issues";
        ...
        internal string VersionTextBlockText
        {
            get
            {
                ...
                string name = loader?.GetString("AppName") ?? "APK Helper";
                return $"{name} v{ver}";
            }
        }
